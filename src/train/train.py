...
parser = argparse.ArgumentParser(description='Structural Compositing Training')
parser.add_argument('--config-path', type=str, default='./configs/comp_v15.yaml')
parser.add_argument('--learning-rate', type=float, default=1e-5)
parser.add_argument('---batch-size', type=int, default=4)
parser.add_argument('---training-steps', type=int, default=15000)
parser.add_argument('---resume-path', type=str, default='./ckpt/init_comp.ckpt')
parser.add_argument('---logdir', type=str, default='./comp_logs/')
parser.add_argument('---log-freq', type=int, default=1250)
...
def main():
    ...
    print("Training steps set to:", training_steps)
